...
namespace Waka\Phpw\Classes\Replacements;
...
class TemplateProcessor
{
    ...
    public function setHtmlValue($search, $replace, $clean = false, $limit = self::MAXIMUM_REPLACEMENTS_DEFAULT)
    {
        ...
        if ($clean) {
            $ooXml = str_replace("<w:r><w:rPr></w:rPr><w:t xml:space='preserve'></w:t></w:r></w:p><w:p><w:r><w:t xml:space='preserve'></w:t></w:r>", "<w:r><w:rPr></w:rPr><w:t xml:space='preserve'></w:t></w:r>", $ooXml);
        }
